...
if ($_POST['areaAtuacaoHidden'] == "Civil"){
	...
	if ($_POST['respostaCivil1'] != "" || $_POST['respostaCivil2'] != "" || $_POST['respostaCivil3'] != "" || $_POST['respostaCivil4'] != "" || $_POST['respostaCivil5'] != ""
		|| $_POST['respostaCivil6'] != "" || $_POST['respostaCivil7'] != "" || $_POST['respostaCivil8'] != "" || $_POST['respostaCivil9'] != "" || $_POST['respostaCivil10'] != ""){
...
if ($_POST['areaAtuacaoHidden'] == "Trabalhista"){
	// Verifica se não vem em branco
	if ($_POST['respostaTrabalhista1'] != "" || $_POST['respostaTrabalhista2'] != "" || $_POST['respostaTrabalhista3'] != ""){
...
if ($_POST['areaAtuacaoHidden'] == "Ambas"){
	...
	if ($_POST['respostaCivil1'] != "" || $_POST['respostaCivil2'] != "" || $_POST['respostaCivil3'] != "" || $_POST['respostaCivil4'] != "" || $_POST['respostaCivil5'] != ""
		|| $_POST['respostaCivil6'] != "" || $_POST['respostaCivil7'] != "" || $_POST['respostaCivil8'] != "" || $_POST['respostaCivil9'] != "" || $_POST['respostaCivil10'] != ""
		|| $_POST['respostaTrabalhista1'] != "" || $_POST['respostaTrabalhista2'] != "" || $_POST['respostaTrabalhista3'] != ""){
